...
public class CaiJingFragment extends Fragment {
    ...
    private String news_Url="http://c.m.163.com/nc/article/list/T1348648756099/0-20.html ";
    ...
    public static CaiJingFragment newInstance() {
    ...
    public HashMap<String, String> getImageSlider() {
        ...
        image.put("国内油价含巨大消费税 出口价仅1.8元", "http://img3.cache.netease.com/3g/2016/1/14/20160114073723fa820.jpg");
        image.put("美股全线暴跌 进入技术性熊市", "http://img4.cache.netease.com/3g/2016/1/14/20160114085341b8904.jpg");
        return image;
    }
    ...
    public void getAsyscDataList() {
        ...
        asyncHttpClient.get(news_Url, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, String s) {
                ...
                List<TAll> tall=news.getT1348648756099();
