...
public class SportFragment extends Fragment {
    ...
    private String news_Url="http://c.m.163.com/nc/article/list/T1348649079062/0-20.html";
    ...
    public HashMap<String, String> getImageSlider() {
        ...
        image.put("国足狂胜致谢球迷 黄博文成焦点", "http://img1.cache.netease.com/3g/2015/11/13/201511131750461f442.jpg");
        image.put("叒输!库里38分 勇士憾负掘金吞第3败", "http://img2.cache.netease.com/3g/2016/1/14/201601141232221a05d.jpg");
        return image;
    }
    ...
    public void getAsyscDataList() {
        ...
        asyncHttpClient.get(news_Url, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, String s) {
                ...
                List<TAll> tall=news.getT1348649079062();
