...
public class KeJiFragment extends Fragment {
    ...
    private String news_Url="http://c.m.163.com/nc/article/list/T1348649580692/0-20.html ";
    ...
    public HashMap<String, String> getImageSlider() {
        ...
        image.put("疑似李彦宏讲话:百度是高尚的", "http://img1.cache.netease.com/3g/2016/1/14/2016011414021556c4e.jpg");
        image.put("IDC：全球Q4 PC出货量创新低", "http://img6.cache.netease.com/3g/2016/1/13/201601131337301a2e4.jpg");
        return image;
    }
